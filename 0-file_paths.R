...
#Each of these subdirectories contains original data files as downloaded from source
...
#Destination directory for writing exported csv containing all observations for complete training and validation data sets

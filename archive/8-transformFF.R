...
#transform required input predictors to ff pobjects for use with Piso.AI application

setwd("INSERT FILE PATH HERE") #this should be the directory for the applciation

###this script assumes that script "2-read_in_spatial_data.R" has already been run
pred_data<-pred_data_out_path

#the xgb.vl.model input csv was generated with the script "6-d2H_simplified_train.R"
#the file was then copied and pasted into this directory
xgb.vars<-read.csv("data/modelRobjects/d2H.xgb.vl.model.inputs.csv")
xgb.vars<-as.character(xgb.vars$x)
...
DEM <- ff(vmode="double",dim=c(ncell(x),nlayers(x)),
          file=paste0(getwd(),"/data/predictors/FFmats/DEM_GTOPO30"))
DEM[,1] <- x[]


ffsave(DEM,file=paste0(getwd(),"/data/predictors/FFmats/DEM_GTOPO30"),
       rootpath=paste0(getwd(),"/data/predictors/FFmats"))
...
writeRaster(CRU.ID_Raster,"data/predictors/FFmats/CRU.ID_Raster",overwrite=T)
...
CRU.mat<-as.ff(CRU.mat,file=paste0(getwd(),"/data/predictors/FFmats/CRU.mat.FF"),overwrite = T)
ffsave(list="CRU.mat",
       file=paste0(getwd(),"/data/predictors/FFmats/CRU.mat.FF"),
       rootpath=paste0(getwd(),"/data/predictors/FFmats"))

saveRDS(CRU.t,file=paste0(getwd(),"/data/predictors/CRU.t"))
saveRDS(CRU.x.y,file=paste0(getwd(),"/data/predictors/CRU.x.y"))
...
EOBS.mat.A<-z
EOBS.mat.A<-as.ff(EOBS.mat.A,file=paste0(getwd(),"/data/predictors/FFmats/EOBS.mat.A.FF"),overwrite = T)
ffsave(list="EOBS.mat.A",
       file=paste0(getwd(),"/data/predictors/FFmats/EOBS.mat.A.FF"),
       rootpath=paste0(getwd(),"/data/predictors/FFmats"))
...
EOBS.mat.B<-z
EOBS.mat.B<-as.ff(EOBS.mat.B,file=paste0(getwd(),"/data/predictors/FFmats/EOBS.mat.B.FF"),overwrite = T)
ffsave(list="EOBS.mat.B",
       file=paste0(getwd(),"/data/predictors/FFmats/EOBS.mat.B.FF"),
       rootpath=paste0(getwd(),"/data/predictors/FFmats"))
...
EOBS.mat.C<-z
EOBS.mat.C<-as.ff(EOBS.mat.C,file=paste0(getwd(),"/data/predictors/FFmats/EOBS.mat.C.FF"),overwrite = T)
ffsave(list="EOBS.mat.C",
       file=paste0(getwd(),"/data/predictors/FFmats/EOBS.mat.C.FF"),
       rootpath=paste0(getwd(),"/data/predictors/FFmats"))
...
EOBS.mat.D<-z
EOBS.mat.D<-as.ff(EOBS.mat.D,file=paste0(getwd(),"/data/predictors/FFmats/EOBS.mat.D.FF"),overwrite = T)
ffsave(list="EOBS.mat.D",
       file=paste0(getwd(),"/data/predictors/FFmats/EOBS.mat.D.FF"),
       rootpath=paste0(getwd(),"/data/predictors/FFmats"))

saveRDS(EOBS.t,file=paste0(getwd(),"/data/predictors/EOBS.t"))
saveRDS(EOBS.x.y,file=paste0(getwd(),"/data/predictors/EOBS.x.y"))
...
NCEP.mat.A<-z
NCEP.mat.A<-as.ff(NCEP.mat.A,file=paste0(getwd(),"/data/predictors/FFmats/NCEP.mat.A.FF"),overwrite = T)
ffsave(list="NCEP.mat.A",
       file=paste0(getwd(),"/data/predictors/FFmats/NCEP.mat.A.FF"),
       rootpath=paste0(getwd(),"/data/predictors/FFmats"))
...
NCEP.mat.B<-z
NCEP.mat.B<-as.ff(NCEP.mat.B,file=paste0(getwd(),"/data/predictors/FFmats/NCEP.mat.B.FF"),overwrite = T)
ffsave(list="NCEP.mat.B",
       file=paste0(getwd(),"/data/predictors/FFmats/NCEP.mat.B.FF"),
       rootpath=paste0(getwd(),"/data/predictors/FFmats"))
...
NCEP.mat.C<-z
NCEP.mat.C<-as.ff(NCEP.mat.C,file=paste0(getwd(),"/data/predictors/FFmats/NCEP.mat.C.FF"),overwrite = T)
ffsave(list="NCEP.mat.C",
       file=paste0(getwd(),"/data/predictors/FFmats/NCEP.mat.C.FF"),
       rootpath=paste0(getwd(),"/data/predictors/FFmats"))


saveRDS(NCEP.t,file=paste0(getwd(),"/data/predictors/NCEP.t"))
saveRDS(NCEP.x.y,file=paste0(getwd(),"/data/predictors/NCEP.x.y"))


TELE<-read.csv(paste0(pred_data,"TELE.csv"),row.names=1)
write.csv(TELE, file=paste0(getwd(),"/data/predictors/TELE.csv"))
